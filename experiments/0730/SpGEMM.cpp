...
void multi_threaded_hashing_SpGEMM(const int *rowPtrA, const int *colIndA, const float *valA, 
    ...
    double start = get_time();
    execute_hashing_SpGEMM(rowPtrA, colIndA, valA, rowPtrB, colIndB, valB, c_rowPtr, c_colInd, c_val, M, N, num_of_threads, NEON);
    double end = get_time();
    if(NEON) 
...
int main(int argc, char *argv[]){
    ...
    // Multi-threaded
    multi_threaded_hashing_SpGEMM(rowPtrA, colIndA, valA, rowPtrB, colIndB, valB, c_rowPtr, c_colInd, c_val, M, N, false);
    multi_threaded_hashing_SpGEMM(rowPtrA, colIndA, valA, rowPtrB, colIndB, valB, c_rowPtr, c_colInd, c_val, M, N, true);
