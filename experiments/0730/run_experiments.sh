...
g++ -fopenmp -o hashing_wN_SpGEMM hashing_wN_SpGEMM.cpp && g++ -fopenmp -o hashing_woN_SpGEMM hashing_woN_SpGEMM.cpp && g++ -fopenmp -o spArr_wN_SpGEMM spArr_wN_SpGEMM.cpp && g++ -fopenmp -o spArr_woN_SpGEMM spArr_woN_SpGEMM.cpp
...
do
    ...
    do
        ...
        perf stat -e cycles,cache-references,cache-misses,LLC-loads,LLC-load-misses,dTLB-loads,dTLB-load-misses ./hashing_woN_SpGEMM $size $density 2>&1 | grep -E '^[ ]+[0-9]' >> $output_file
        ...
        perf stat -e cycles,cache-references,cache-misses,LLC-loads,LLC-load-misses,dTLB-loads,dTLB-load-misses ./spArr_woN_SpGEMM $size $density 2>&1 | grep -E '^[ ]+[0-9]' >> $output_file
