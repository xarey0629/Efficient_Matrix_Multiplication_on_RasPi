...
void spArr_SpGEMM(const int *rowPtrA, const int *colIndA, const float *valA, 
                            ...
                            bool NEON, int num_of_threads = omp_get_max_threads()){
    double start = get_time();
    execute_spArr_SpGEMM(rowPtrA, colIndA, valA, rowPtrB, colIndB, valB, c_rowPtr, c_colInd, c_val, M, N, NEON, num_of_threads);
    double end = get_time();
...
int main(int argc, char *argv[]){
    ...
    // hashing_SpGEMM(rowPtrA, colIndA, valA, rowPtrB, colIndB, valB, c_rowPtr, c_colInd, c_val, M, N, true);            // NEON OFF
